...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        defaultFileActionSettings = {
            removeIcon: '<i class="mdi-action-delete"></i>',
    ...
    FileInput.prototype = {
        ...
        previewDefault: function (file, previewId, isDisabled) {
            ...
            if (isDisabled === true) {
                ...
                footer += '<div class="file-other-error text-danger"><i class="mdi-alert-warning"></i></div>';
            }
    ...
    $.fn.fileinput.defaults = {
        ...
        previewFileIcon: '<i class="mdi-editor-insert-drive-file"></i>',
        browseIcon: '<i class="mdi-content-add"></i> &nbsp;',
        browseClass: 'btn btn-primary',
        removeIcon: '<i class="mdi-action-delete"></i> ',
        removeClass: 'btn btn-default',
        cancelIcon: '<i class="mdi-action-highlight-remove"></i> ',
        cancelClass: 'btn btn-default',
        uploadIcon: '<i class="mdi-file-cloud-upload"></i> ',
        ...
        msgValidationErrorIcon: '<i class="mdi-alert-warning"></i> ',
